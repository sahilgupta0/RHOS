...
async def convert_text_to_speech(request: TextToSpeechRequest, current_user: CurrentUser = None):
    ...
    try:
        ...
        if audio_bytes:
            ...
            return {"message": "Server-side TTS not available. Use browser SpeechSynthesis.", "use_browser_tts": True}
    except Exception as e:
